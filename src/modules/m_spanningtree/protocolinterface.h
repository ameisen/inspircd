...
class SpanningTreeProtocolInterface : public ProtocolInterface
{
 public:
	...
	bool SendEncapsulatedData(const std::string& targetmask, const std::string& cmd, const parameterlist& params, User* source) override;
	void BroadcastEncap(const std::string& cmd, const parameterlist& params, User* source, User* omit) override;
